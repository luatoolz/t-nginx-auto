...
=== TEST 1: t.nginx.auto.respond GET nil
--- http_config
...
content_by_lua_block { t.nginx.auto.respond(nil) }}
--- request
GET /t
--- more_headers
--- response_body
...
=== TEST 2: t.nginx.auto.respond HEAD nil
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
=== TEST 3: t.nginx.auto.respond DELETE nil
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
=== TEST 4: t.nginx.auto.respond PUT nil
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
