...
=== TEST 1: t.nginx.auto.respond GET empty string
--- http_config
...
=== TEST 2: t.nginx.auto.respond HEAD empty string
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
=== TEST 3: t.nginx.auto.respond DELETE empty string
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
=== TEST 4: t.nginx.auto.respond PUT empty string
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
