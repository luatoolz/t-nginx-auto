...
{"_id":{"$oid":"66ef5a258aa5f11c0c094b26"},"role":"traffer","token":"46db395df332f18b437d572837d314e421804aaed0f229872ce7d8825d11ff9a"}]
--- timeout: 5s
--- response_headers
--- error_code: 200
--- no_error_log
...
=== TEST 6: GET /t/auth/root limit 2
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
[{"_id":{"$oid":"66ef5a258aa5f11c0c094b25"},"role":"root","token":"95687c9a1a88dd2d552438573dd018748dfff0222c76f085515be2dc1db2afa7"},
{"_id":{"$oid":"66ef5a258aa5f11c0c094b26"},"role":"traffer","token":"46db395df332f18b437d572837d314e421804aaed0f229872ce7d8825d11ff9a"},
{"_id":{"$oid":"66ef5a258aa5f11c0c094b27"},"role":"panel","token":"60879afb54028243bb82726a5485819a8bbcacd1df738439bfdf06bc3ea628d0"},
{"_id":{"$oid":"66ef5a258aa5f11c0c094b28"},"role":"root","token":"e150a1ec81e8e93e1eae2c3a77e66ec6dbd6a3b460f89c1d08aecf422ee401a0"}]
--- timeout: 5s
--- response_headers
--- error_code: 200
...
=== TEST 8: GET auth limit 4 / skip 1
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
...
=== TEST 9: GET auth limit 4 / skip 1
--- http_config
lua_package_path "lua/?.lua;lua/?/init.lua;?.lua;?/init.lua;;";
init_by_lua_block { require "t" }
--- config
